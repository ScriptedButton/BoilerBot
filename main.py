...
async def courseinfo(ctx, subject, number):
    ...
    embed = discord.Embed(title=course.getTitle(), description=course.getDescription(), color=0xdbce14)
    embed.add_field(name="Credit Hours", value=course.getCredits(), inline=False)
